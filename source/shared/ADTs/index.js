...
const promiseSettled = (val) => Promise.resolve(val);
const promiseRejedct = (err) => Promise.reject(err);

const contractReducer = {};
// const createPromise = (val) => new Promise((res, rej) !res : rej() :res();

// const addToMap = brand => M.set(brand, initialPoolValues)
